...
class UserOrder extends Controller
{
    ...
    public function riwayat_order(Request $req){
        ...
        $riwayat->menu = $req->isset($data[$id_menu]);
        $riwayat->jumlah_pesanan = $req->isset($data[$id_menu]);
        $riwayat->harga = $req->isset($data[$id_menu]);
        $riwayat->total_harga = $req->isset(total[$id_menu];
