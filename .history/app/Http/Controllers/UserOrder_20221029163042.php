...
class UserOrder extends Controller
{
    ...
    public function riwayat_order(Request $req){
        ...
        $detail_trans->kwantitas = $req->kwantitas[$id_menu];
        $detail_trans->satuan = $req->satuan[$id_menu];
        $detail_trans->diskon = $req->diskon[$id_menu];
        $detail_trans->total = $req->total[$id_menu];
