            ...
            <aside class="sidebar-wrapper ">
              <nav class="sidebar-nav">
                 ...
                 <li class="header ml-2 mt-2">Cafe</li>
                      ...
                      <li class="single-nav-wrapper">
                        <a href="/tambah" class="menu-item">
                            <span class="left-icon"><i class="fa fa-file"></i></span>
                            <span class="menu-text">Tambah Menu</span>
                        </a>
                      </li>

                      <li class="single-nav-wrapper">
                        <a href="/tampil" class="menu-item">
                            <span class="left-icon"><i class="fa fa-file"></i></span>
                      ...
                      <li class="single-nav-wrapper">
                        <a href="/riwayat" class="menu-item">
                            <span class="left-icon"><i class="fa fa-file"></i></span>
                            <span class="menu-text">Riwayat Penjualan</span>
                        </a>
                      </li>

                      <li class="header ml-2 mt-2">Pengeluaran</li>
                      <li class="single-nav-wrapper">
                        <a href="https://cafe2.smkbagimunegeriku.sch.id/home" target="_blank" class="menu-item">
                            <span class="left-icon"><i class="fa fa-file"></i></span>
