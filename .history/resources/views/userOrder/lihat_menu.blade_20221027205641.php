            ...
            <div class="container">
                <br>
                        ...
                        <label for="{{$no}}">
                            ...
                            <input type="checkbox" name="harga" value="{{$key->menu}}" class="{{$no++}}">
                            <input type="checkbox" name="harga" value="{{$key->harga}}" class="checkbox {{$no2++}}">
                        </label>
                        @endforeach
...
<script>
    $(document).ready(function(){
        ...
        $(".{{$no}}").change(function(){
			$(".{{$no2}}").prop("checked", $(this).prop("checked"))
		})
		...
		$(".{{$no2}}").change(function(){
			...
			if($(".{{$no2}}:checked").length == $(".checkitem").length){
