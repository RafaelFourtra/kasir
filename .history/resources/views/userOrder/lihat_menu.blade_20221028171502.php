                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        <tr>
                                        <td><b name="menu">{{$key->menu}}</b></td>
                                        <td><input name="kwantitas" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><b class="harga">Rp.{{number_format($key->harga)}}</b></td>
                                        <td><b id="{{$no10++}}">Rp.{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                </tbody>
