        ...
        <form class="our-form">
            ...
            <div class="container">
                <br>
                        ...
                        <input type="checkbox" name="menu" value="{{$key->harga}} {{$key->menu}}" id="{{$no++}}" class="checkbox2">
                        <input type="checkbox" name="harga" value="{{$key->harga}} {{$key->menu}}" id="{{$no++}}" class="checkbox2">
                        @endforeach
