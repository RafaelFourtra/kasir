        ...
        <form class="our-form">
            ...
            <div class="container">
                <br>
                        ...
                        <input type="checkbox" onclick="checkMe()" name="data" value="{{$key->harga}}" id="{{$no}}" class="lol">
                        @endforeach
            </div>
...
<script>
    ...
    function checkMe(){
        var cb = document.getElementsByClassName("lol");
        var text = document.getElementsByCl("msg");
        if(cb.checked==true){
