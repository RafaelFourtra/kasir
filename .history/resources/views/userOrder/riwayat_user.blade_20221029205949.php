            ...
            <table class="table table-striped">
                ...
                <tbody>
                  @foreach($transaksi as $data)
                    ...
                    <td><a href="riwayat_order/{id} #detail"><button class="btn btn-warning tombol">Detail</button></a>
                        <a href="tambah/{{$data->id}}" class="btn btn-danger">Delete</a></td>
                    </tr>
                  @endforeach
