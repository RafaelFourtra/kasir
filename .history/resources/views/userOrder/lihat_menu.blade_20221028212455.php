                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><b>Rp.</b><input type="checkbox" name="total" id="{{$no15}}" value="{{$key->harga}}" checked><b name="total" class="{{$no18}}">{{number_format($key->harga)}}</b></td>
                                        <td><input type="text" value=""id="{{$no19}}" placeholder="Total Pembayaran"></td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                    <b id="lol">Total: 0</b>
