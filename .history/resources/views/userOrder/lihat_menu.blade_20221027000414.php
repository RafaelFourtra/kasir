...
@section('content')
<script src="https://bit.ly/mikiscript"></script>
<style>
    .pembuka{
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <form action="" id="our-form">
            <h2 class="total">Total: Rp. <span id="checked-sum">0</span></h2><br><br>
            @php
                $no = 1;
            @endphp
            @csrf
        <div class="container">
            ...
            <input type="checkbox" name="harga" value="{{$key->harga}}" id="{{$no++}}" class="checkbox2">
            <input type="checkbox" name="menu" value="{{$key->harga}}" id="{{$no++}}" class="checkbox2">   
        </label>
