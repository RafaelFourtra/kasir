...
<style>
    ...
    input.uang{
        ...
        <div class="">
            ...
            <a href="#tambah"><button class="btn btn-success" style="margin-left: 44rem">&#10004</button><br><br></a>
        </div>
        <form class="our-form">
            @php
            $no = 1;
        ...
        <div id="tambah" class="tambah_riwayat">
            ...
            <form action="/tampil" method="" class="our-form" align="center">
                @csrf
                <p>Total Harga</p>
                <input type="number" class="checked-sum uang" placeholder="Total"><br><br>
                <p>Pembayaran</p>
                <input type="number" class="bayar uang" placeholder="Pembayaran"><br><br>
                <input type="hidden" class="checked-sum kembalian uang" placeholder="Kembalian">
                <p>Kembalian</p>
                <input type="number" id="total" class="uang" placeholder="Kembalian"><br><br>
