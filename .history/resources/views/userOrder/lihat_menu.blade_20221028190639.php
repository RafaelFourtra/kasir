...
<style>
    ...
    input.uang{
        ...
        <div id="tambah" class="tambah_riwayat">
            ...
            <form action="/tampil" method="POST" class="our-form" align="center" name="frm">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input type="checkbox" name="jumlah_pesanan" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><input type="checkbox" name="harga" class="harga">Rp.{{number_format($key->harga)}}</td>
                                        <td><b>Rp.</b><b name="total" id="{{$no10++}}">{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                </tbody>
