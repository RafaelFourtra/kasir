                            ...
                            <div class="col-lg-12">
                                <table class="table table-striped" style="width: 28rem; margin-left: 25rem;width: 300rem;">
                                        ...
                                        <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                            ...
                                            <td><input name="pesanan[]" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="0"></td>
                                            <td><input class="checkbox" type="checkbox" name="harga[]" class="harga" value="{{$key->harga}}" checked>Rp.{{number_format($key->harga)}}</td>
                                            <td><b>Rp.</b><input class="checkbox {{$noTotal++}}" type="checkbox" name="total[]" id="{{$no15++}}" value="{{$key->harga}}" checked><b name="total" id="{{$no10++}}">{{number_format($key->harga)}}</b></td>
                                        </tr>
                                        </tbody>
                                        @endforeach
