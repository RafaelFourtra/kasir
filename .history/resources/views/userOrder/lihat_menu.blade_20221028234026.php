                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input type="checkbox" id="menu" name="menu[0]" value="{{$key->menu}}" checked>{{$key->menu}}</td>
                                        <td><input name="pesanan" type="number[0]" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
