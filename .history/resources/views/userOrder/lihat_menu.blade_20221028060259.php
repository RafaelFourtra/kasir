...
<style>
    ...
    input.uang{
        ...
        <div class="">
            ...
            <a href="#tambah"><button class="btn btn-success" style="margin-left: 38rem" onclick="getClick(this.value)">&#10004</button><br><br></a>
        </div>
        <form class="our-form">
            @php
            $no = 1;
            ...
            <div class="container">
                <br>
                        ...
                        <input type="checkbox" onclick="hideButton(this)" name="data" value="{{$key->harga}}" id="{{$no++}}" class="checkbox">
                        @endforeach
            </div>
