                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input type="checkbox" name="harga" value="12000" class="harga" checked>Rp.{{number_format($key->harga)}}</td>
                                        <td><b>Rp.</b><input type="checkbox" name="total" id="{{$no10++}}"  checked>{{number_format($key->harga)}}</td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                </tbody>
