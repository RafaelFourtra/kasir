                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;width: 300rem;">
                                    ...
                                    <tbody>
                                        ...
                                        <td><input class="checkbox2" type="text" id="{{$no24++}}" name="menu[]" value="{{$key->menu}}">{{$key->menu}}</td>
                                        <td><input name="pesanan[]" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><input class="checkbox2" id="{{$noku++}}" type="text" name="harga[]" class="harga" value="{{$key->harga}}">Rp.{{number_format($key->harga)}}</td>
