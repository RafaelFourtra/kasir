            ...
            <div class="container">
                <br>
                        ...
                        <label for="{{$no}}">
                            ...
                            <input type="checkbox" name="menu" onchange="checkAll(this)" value="{{$key->menu}}" class="lol">
                            <input type="checkbox" name="harga" value="{{$key->harga}}">
                        </label>
                        @endforeach
...
<script>
    ...
    function checkAll(ele) {
       var checkboxes = document.getElementsByClassName('.lol').length;
       if (ele.checked) {
