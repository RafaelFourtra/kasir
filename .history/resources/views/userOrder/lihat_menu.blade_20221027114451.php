    ...
    width: 190px;
        ...
        <div id="tambah" class="tambah_riwayat">
            <form action="" method="" class="our-form">
                ...
                <input type="number" class="checked-sum" placeholder="Total"><br>
                <input type="number" class="bayar" placeholder="Pembayaran"><br>
                <input type="number" class="checked-sum kembalian" placeholder="Kembalian"><br>
