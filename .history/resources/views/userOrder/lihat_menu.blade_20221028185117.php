                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input type="checkbox" name="harga" class="harga" value="{{number_format($key->harga)}}" checked>Rp.{{number_format($key->harga)}}</td>
                                        <td><b>Rp.</b><input type="checkbox" name="total" id="{{$no10++}}" value="{{number_format($key->harga)}}" checked>{{number_format($key->harga)}}</td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                </tbody>
