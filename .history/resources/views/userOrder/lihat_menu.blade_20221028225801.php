                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input type="checkbox" id="menu" name="checkbox[]" value="{{$key->menu}}" checked>{{$key->menu}}</td>
                                        <td><input name="jumlah_pesanan" name="checkbox[]" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><input type="checkbox" name="checkbox[]" class="harga" value="{{$key->harga}}" checked>Rp.{{number_format($key->harga)}}</td>
                                        <td><b>Rp.</b><input type="checkbox" name="total_harga[]" id="{{$no15++}}" value="{{$key->harga}}" checked><b name="total" id="{{$no10++}}">{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    </tbody>
                                    <b></b>
                                    @endforeach
