...
<style>
    ...
    input.uang{
        ...
        {{-- MODAL --}}
        <div id="tambah" class="tambah_riwayats">
            <div class="isian">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;width: 300rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input class="checkbox2" type="checkbox" id="{{$no24++}}" name="menu[]" value="{{$key->menu}}">{{$key->menu}}</td>
                                        <td><input name="pesanan[]" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><input class="checkbox2" id="#harga" type="checkbox" name="harga[]" class="harga" value="{{$key->harga}}">Rp.{{number_format($key->harga)}}</td>
...
function checkMe(id,pid){
    ...
    $("#harga").prop("checked", $(this).prop("checked"));
