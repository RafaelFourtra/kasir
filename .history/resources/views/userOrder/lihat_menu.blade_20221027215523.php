            ...
            <div class="container">
                <br>
                        ...
                        <label for="{{$no}}">
                            ...
                            <input type="checkbox" name="menu" onchange="checkAll(this)" value="{{$key->menu}}" class="{{$no++}}">
                            <input type="checkbox" name="harga" onchange="checkAll(this)" class="{{$n2o++}}" value="{{$key->harga}}">
                        </label>
                        @endforeach
