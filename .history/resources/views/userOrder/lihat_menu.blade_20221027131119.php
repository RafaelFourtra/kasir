    ...
    .isian{
        ...
        <div id="tambah" class="tambah_riwayat">
            ...
            <form action="" method="" class="our-form" align="center">
                @csrf
                <p>Total Harga</p>
                <input type="number" class="checked-sum uang" placeholder="Total">
                <p>Pembayaran</p>
                <input type="number" class="bayar uang" placeholder="Pembayaran">
                <input type="hidden" class="checked-sum kembalian" placeholder="Kembalian">
                <p>Kembalian</p>
                <input type="number" id="total" placeholder="Total Dibayar"><br><br>
