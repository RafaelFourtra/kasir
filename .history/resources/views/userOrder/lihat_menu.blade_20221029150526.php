...
<style>
    ...
    input.uang{
        ...
        {{-- MODAL --}}
        <div id="tambah" class="tambah_riwaya">
            <div class="isian">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;width: 300rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><input class="checkbox2" type="checkbox" id="{{$no22}}" name="menu[]" value="{{$key->menu}}">{{$key->menu}}</td>
                                        <td><input name="pesanan[]" type="number" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><input class="checkbox2" type="checkbox" id="{{$no23}}" name="harga[]" class="harga" value="{{$key->harga}}">Rp.{{number_format($key->harga)}}</td>
                                        <td><b>Rp.</b><input class="checkbox2" type="checkbox" name="total[]" id="{{$no15++}}" value="{{$key->harga}}"><b name="total" id="{{$no10++}}">{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    </tbody>
                                    <b></b>
                                    @endforeach
...
function checkMe(id,pid){
   ...
   $("#{{$no14++}}").click(function() {
	$("#{{$no22++}}").prop("checked", $(this).prop("checked"));
    $("#{{$no23++}}").prop("checked", $(this).prop("checked"));
});
