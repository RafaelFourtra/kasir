        ...
        <form class="our-form">
            ...
            <div class="container">
                <br>
                        ...
                        <input type="checkbox" onclick="checkMe()" name="data" value="{{$key->harga}}" id="lol" class="checkbox">
                        @endforeach
            </div>
...
<script>
    ...
    function checkMe(){
        var cb = document.getElementsById("checkbox");
        var text = document.getElementByTagName("table");
        if(cb.checked==true){
