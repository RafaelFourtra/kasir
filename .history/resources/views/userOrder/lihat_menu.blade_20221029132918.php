                            ...
                            <div class="col-lg-12">
                                <table class="table table-striped" style="width: 28rem; margin-left: 25rem;width: 300rem;">
                                        ...
                                        <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                            ...
                                            <td><b>Rp.</b><input class="checkbox" type="checkbox" name="total[]" id="{{$no15++}}" value="{{$key->harga}}" checked><b name="total" id="{{$no10++}}">{{number_format($key->harga)}}</b></td>
                                        </tr>
                                        </tbody>
                                        @endforeach
                                       <b>Total: </b> <b class="totalz">0</b>
                                    </tbody>
                                </thead>
                            </table>
                            </div>
    ...
    function totalAmount(){
                var totals = document.getElementById('#{{$noTotal++}}');
                var amount = document.getElementById('#{{$noTotal2++}}');
                // $('#{{$noTotal++}}').each(function(i, e){
                //     var amount = $(this).val() -0;
                //     totals += amount;
                // });

               var hasil = totals+=amount;
