                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        <tr>
                                        <td><input type="checkbox" id="menu" name="menu" value="{{$key->menu}}">{{$key->menu}}</td>
                                        <td><input name="jumlah_pesanan" type="number" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><b name="harga" class="harga">Rp.{{number_format($key->harga)}}</b></td>
                                        <td><b name="total" id="{{$no10++}}">Rp.{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                </tbody>
...
document.querySelector('#menu:checked') !== null;
