                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        ...
                                        <td><b>Rp.</b><input type="text" name="total" id="{{$no15}}" value="{{$key->harga}}" checked><input type="text" name="total_pesanan" id="{{$no15}}" value="{{$key->harga}}" checked><b name="total" class="{{$no18}}">{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                    <b id="lol">Total: 0</b>
