            ...
            <div class="container">
                <br>
                        ...
                        <label for="{{$no5++}}">
                            ...
                            <input type="checkbox" onclick="checkMe(this.id,'{{$no++}}')" name="data" value="{{$key->harga}}" id="{{$no2++}}" class="checkbox harga">
                        </label>
                        @endforeach
            </div>
                            ...
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                ...
                                <tbody>
                                    ...
                                    <tbody id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        <tr>
                                        <td><b>{{$key->menu}}</b></td>
                                        <td><input type="number" class="kwantitas" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><b>{{$key->harga}}</b></td>
                                        <td><input type="number" id="total" value=""style="width: 100px;text-align: center;"></td>
                                    </tr>
                                    </tbody>
                                    @endforeach
                                </tbody>
...
function checkMe(id,pid){
    ...
    $(document).ready(function(){
        $(".kwantitas,.harga").keyup(function(){
            var total=0;
            var x = Number($(".kwantitas").val());
            var y = Number($(".harga").val());
            var total=x *  y;
            $('#total').val(total);
            //alert("lol")
        });
