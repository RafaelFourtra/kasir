            ...
            <div class="container">
                <br>
                        ...
                        <label for="{{$no}}">
                            ...
                            <input type="checkbox" name="harga" value="{{$key->harga}}" class="{{$no}}">
                        </label>
                        <input type="checkbox" name="harga" value="{{$key->harga}}" class="checkbox">
                        @endforeach
...
<script>
    $(document).ready(function(){
		...
		$(".{{$no}}").click(function(){
			...
			if($(".{{$no}}:checked").length == $(".checkbox").length){
