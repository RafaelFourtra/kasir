...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <form action="/tampil" method="POST" id="our-form">
            <h2 class="total">Total: Rp. <span id="checked-sum">0</span><button>&#10004</button></h2><br><br>
            @php
                $no = 1;
                $no2 = 1;
            @endphp
        ...
        <div class="container">
            ...
            <input type="checkbox" name="nama" value="{{$key->menu}}" id="{{$no2++}}">
            <input type="checkbox" name="harga" value="{{$key->harga}}" id="{{$no++}}">   
        </label>
