...
<style>
    ...
    .pilih .checkbox:checked ~ .option_inner{
        border-color: red;
    }
</style>
        <h2 class="pembuka">Pilih Pesanan Anda!</h2><br>
        <div class="">
            <h2 class="total">Total: Rp. <span class="checked-sum">0</span></h2>
            <a href="#tambah"><button class="btn btn-success" style="margin-left: 43rem">&#10004</button><br><br></a>
        </div>
        <form class="our-form">
            @php
            ...
            <div class="container">
                <br>
                        @foreach($menu as $key)
                        <label for="{{$no5++}}" class="pilih">
                            <img style="border: black" src="{{asset('uploads/menu/'.$key->gambar)}}">
        ...
        <div id="tambah" class="tambah_riwayat">
            ...
            <form action="/tampil" method="POST" align="center" name="frm">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                                <b>Selamat Berbelanja!!!</b>
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;width: 300rem;">
                                    
                                    <tbody>
                                        @foreach($menu as $key)
                                        <tr id="{{$no3++}}" style="display: none; margin-left: 5rem;">
                                        <td><input type="hidden" name="id_menu[]" value="{{$key->id_menu}}"></td>
                                        <td><input class="checkbox" type="checkbox" id="{{$no24++}}" name="menu[]" value="{{$key->menu}}">{{$key->menu}}</td>
                                        <td><input name="pesanan[]" type="text" id="{{$no12++}}" style="width: 50px;text-align: center;" value="1"></td>
                                        <td><input class="checkbox" id="{{$noku++}}" type="text" name="harga[]" class="harga" value="{{$key->harga}}">Rp.{{number_format($key->harga)}}</td>
                                        <td><b>Rp.</b><input class="checkbox2" type="text" name="total[]" id="{{$no15++}}" value="{{$key->harga}}"><b name="total" id="{{$no10++}}">{{number_format($key->harga)}}</b></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                    <b></b>
