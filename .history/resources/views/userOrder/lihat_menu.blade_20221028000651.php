...
<style>
    ...
    input.uang{
        ...
        <div class="">
            ...
            <a href="#tambah"><button class="btn btn-success" style="margin-left: 38rem" onclick="chktpl()">&#10004</button><br><br></a>
        </div>
        <form class="our-form">
            @php
            $no = 1;
            ...
            <div class="container">
                <br>
                        ...
                        <input type="checkbox" name="data" value="{{$key->harga}}" id="{{$no++}}" class="checkbox">
                        @endforeach
                            ...
                            <table class="table table-striped" style="width: 28rem; margin-left: 25rem;">
                                ...
                                <tbody>
                                  {{-- @foreach($lihat as $key)
                                    <tr>
                                    <th scope="row">{{$no++}}</th>
                                    <td>Ayam Lengkuas,Ikan Bakar,Spageti,Indomie</td>
...
<script>
    ...
    function chktpl(){
        var chk = document.forms["frm"].elements["data"];
        var isichk="";
        for(i=0;i<chk.length;i++){
            if(chk[i].checked==true){
                isichk += "<td>"+chk[i].value+"</td><br>";
            }
            document.getElementById("tambah").innerHTML=isichk;
        }
    }
