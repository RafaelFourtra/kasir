...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::view("system","userOrder.system");
    ...
    Route::get("riwayat",[UserOrder::class,"riwayat_tampil"]);
    Route::get("detail/{id}",[UserOrder::class,"detail_tampil"]);
    Route::get("riwayat/{id}",[UserOrder::class,"hapus_data"]);

    Route::get("system",[UserOrder::class,"system"]);
    Route::get("system/{id}",[UserOrder::class,"system2"]);
