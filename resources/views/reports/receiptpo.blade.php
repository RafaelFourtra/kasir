    ...
    <div id="printed-content">
        ...
        <div class="mid">
            ...
            <div class="info-customer">
                <p>
                    Nama: {{$lastIDorder -> namapo}}<br>
                    Contact: {{$lastIDorder -> contactpo}}<br>
                    Address: {{$lastIDorder -> addres}}<br>
        ...
        <div class="bot">
            <div id="table">
                <table>
                    ...
                    <tr class="service">
                        <td id="p-list" class="item"><p class="itemtext">{{ $receipt-> nama_menu }}</p></td>
