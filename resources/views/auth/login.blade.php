...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('panel/assets/images/bnlogo.png') }}" >
        <!--Page title-->
        <title>Login</title>
        <!--bootstrap-->
            ...
            <div class="content_wrapper">
                    ...
                    <div class="login_page center_container">
                        <div class="center_content">
                            <div class="logo">
                                <img src="{{ asset('panel/assets/images/bnlogo.png') }}" alt="" class="img-fluid">
                            </div>
                            ...
                            <form action="{{ route('login') }}" class="d-block" method="post">
                                ...
                                <div class="form-group icon_parent">
                                     <label for="password" style="color:#354412;">Email</label>
         <input type="email" class="form-control"  name="email" placeholder="Email Address">
              <span class="icon_soon_bottom_right"><i class="fas fa-envelope"></i></span>
                                 
                                </div>
                                <div class="form-group icon_parent">
                                    <label for="password" style="color:#354412;">Password</label>
       <input type="password" class="form-control" name="password" placeholder="Password">
                                        
                                    <span class="icon_soon_bottom_right"><i class="fas fa-unlock"></i></span>
                                </div>
                                <div class="form-group">
                                    <label class="chech_container" style="color:#354412;">Remember me
                                        <input type="checkbox" name="remember" id="remember" >
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="form-group">
                                    <button type="submit"  class="btn btn-green active">Login</button>
                                </div>
                            </form>
                            <div class="footer" style="color:#354412;">
                               <p>Copyright &copy; 2022 <a href="https://easylearningbd.com/" style="color:#354412;">Dapur Negeriku</a>. All rights reserved.</p>
                            </div>
